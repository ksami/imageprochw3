...
save(fRectP, 'RM1', 'RM2', 'A1n', 'A2n', 'R1n', 'R2n', 'T1n', 'T2n');
...
if ~isempty(strfind(fParam,'office')),
    imwrite(rectIL, '../result/rectIL_office.pgm') ;
    imwrite(rectIR, '../result/rectIR_office.pgm') ;
else
    imwrite(rectIL, '../result/rectIL_street.pgm') ;
    imwrite(rectIR, '../result/rectIR_street.pgm') ;
end
